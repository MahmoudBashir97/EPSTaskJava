...
public class GpsTracker_Location extends Service implements LocationListener {
    ...
    public GpsTracker_Location(Context context) {
    ...
    public void stopUsingGPS(){
        if(locationManager != null){
            locationManager.removeUpdates(GpsTracker_Location.this);
        }
    }
